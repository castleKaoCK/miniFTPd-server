...
void 	priv_sock_init(session_t *);	//初始化内部进程间通信通道
void 	priv_sock_close(session_t *);	//关闭内部进程间通信通道
void 	priv_sock_set_parent_context(session_t *);	//设置父进程环境
void 	priv_sock_set_child_context(session_t *);	//设置子进程环境
